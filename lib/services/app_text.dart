...
class AppText {
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'dismiss': 'Dismiss',
      'i_took_it': "I took it ✅",
      'care_contacts_title': 'Care contacts',
      'care_contacts_subtitle':
          "Add a family member or caregiver's WhatsApp number. We'll message them if you seem to miss a medicine dose, and again shortly before your appointments.",
      'care_contact_name': 'Name',
      'care_contact_phone': 'WhatsApp number (with country code)',
      'care_contact_phone_hint': 'e.g. +919876543210',
      'care_contact_notify_missed_medicine': 'Notify if I miss a medicine dose',
      'care_contact_notify_before_appointment': 'Notify before my appointments',
      'care_contact_add': 'Add contact',
      'care_contact_empty': 'No care contacts added yet.',
      'care_contact_whatsapp_note':
          'Sent over WhatsApp by our backend, so it reaches them even if this phone is off. If you\u2019re using Twilio\u2019s free sandbox for this, each contact needs to message the sandbox\u2019s join code once before they can receive alerts.',
    ...
    'hi': {
      ...
      'dismiss': 'बंद करें',
      'i_took_it': 'मैंने ले ली ✅',
      'care_contacts_title': 'देखभाल संपर्क',
      'care_contacts_subtitle':
          'परिवार के किसी सदस्य या देखभालकर्ता का व्हाट्सऐप नंबर जोड़ें। अगर आप दवा की खुराक लेना भूल जाते हैं तो हम उन्हें संदेश भेजेंगे, और आपकी अपॉइंटमेंट से कुछ समय पहले भी।',
      'care_contact_name': 'नाम',
      'care_contact_phone': 'व्हाट्सऐप नंबर (देश कोड सहित)',
      'care_contact_phone_hint': 'जैसे +919876543210',
      'care_contact_notify_missed_medicine': 'अगर मैं दवा की खुराक भूल जाऊं तो सूचित करें',
      'care_contact_notify_before_appointment': 'मेरी अपॉइंटमेंट से पहले सूचित करें',
      'care_contact_add': 'संपर्क जोड़ें',
      'care_contact_empty': 'अभी तक कोई देखभाल संपर्क नहीं जोड़ा गया।',
      'care_contact_whatsapp_note':
          'हमारे बैकएंड द्वारा व्हाट्सऐप पर भेजा जाता है, इसलिए फोन बंद होने पर भी यह पहुंचता है। अगर आप इसके लिए Twilio के फ्री सैंडबॉक्स का उपयोग कर रहे हैं, तो अलर्ट पाने से पहले हर संपर्क को एक बार सैंडबॉक्स का जॉइन कोड भेजना होगा।',
